...
<head>
    ...
    <title>@yield('title', 'Birthday Wishlist')</title>
...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ route('admin.gifts.index') }}" class="text-gray-700 hover:text-pink-600">
    ...
    <footer class="bg-white shadow-lg mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center text-gray-600">
            <p>&copy; {{ date('Y') }} Birthday Wishlist. Tous droits réservés.</p>
        </div>
    </footer>
</body>
</html>
